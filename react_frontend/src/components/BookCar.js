                        ...
                        <form className="form-group" onSubmit={this.mySubmitHandler}>
                            <div className="row">
                                <div className="col-6">
                                    ...
                                    <input type="date" className="form-control" required name="pickupDate" defaultValue={this.state.pickupDate} onChange={this.myChangeHandler}></input>
                                </div>
                                <div className="col-6">
                                    <label><span style={{color:"red"}}>*</span>Select Drop Date : </label>
                                    <input type="date" className="form-control" required name="dropDate" defaultValue={this.state.dropDate} onChange={this.myChangeHandler} ></input>
                                </div>
                            </div><br />
                            <div className="row mt-2">
                                <div className="col-6">
                            ...
                            <div className="row mt-2">
                                ...
                                <div className="col-6">
                                    <div className="row">
                                        <div className="col-6">
                                            <label className="sublabel">City : </label>
                                            <input type="text" className="form-control" name="pickupcity" defaultValue={this.state.pickupcity} placeholder={"Enter City"} onChange={this.myChangeHandler}></input>
                                        </div>
                                        <div className="col-6">
                                            <label className="sublabel">State : </label>
                                            <input type="text" className="form-control col-3" name="pickupstate" defaultValue={this.state.pickupstate} placeholder={"Enter State"} onChange={this.myChangeHandler}></input>
                                        </div>
                                    </div>
